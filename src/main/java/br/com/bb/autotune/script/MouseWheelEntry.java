 ...
 * @author F6036477
 */
public class MouseWheelEntry implements RecordScriptEntry {

  public static final String ENTRY_REGEX = "mouseWheel\\(\\s?([0-9])\\s?\\)";
  ...
  public RecordAction parse(String s) {
    ...
    return new DefaultRecordAction(p->p.getAutotune().mouseWheel(btn), 
